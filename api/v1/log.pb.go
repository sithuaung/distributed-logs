...
const file_api_v1_log_proto_rawDesc = "" +
	...
	"\x06record\x18\x02 \x01(\v2\x0e.log.v1.RecordR\x06record\"^\n" +
	"\x06Record\x12\x14\n" +
	...
	"\n" +
	"GetServers\x12\x19.log.v1.GetServersRequest\x1a\x1a.log.v1.GetServersResponse\"\x00B(Z&github.com/igor-baiborodine/api/log_v1b\x06proto3"
